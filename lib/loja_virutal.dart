...
import 'package:loja_simples/widget/item_produto.dart';
import 'package:loja_simples/widget/mobile_app_bar.dart';
import 'package:loja_simples/widget/web_app_bar.dart';
...
class _LojaVirtualState extends State<LojaVirtual> {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(builder: (context, constraint) {
      ...
      var alturaBarra =
          AppBar().preferredSize.height; // captura a altura da barra appbar
      return Scaffold(
        appBar: largura < 600
            ? PreferredSize(
                child: MobileAppBar(),
        ...
        body: Padding(
          ...
          child: GridView.count(
            ...
            children: [
              ...
              ItemProduto("Galaxy 10", "3.200,00", "p5.jpg"),
              ItemProduto("Iphone 8", "3.900,00", "p6.jpg"),
              ItemProduto("Kit Multimídia", "2.200,00", "p1.jpg"),
              ItemProduto("Pneu Goodyear aro 16", "800,00", "p2.jpg"),
              ItemProduto("Samsung 9", "4.100,00", "p3.jpg"),
              ItemProduto("Samsung Edge", "2.150,00", "p4.jpg"),
